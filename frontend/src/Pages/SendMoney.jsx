...
export function SendMoney(props) {
        ...
        return (
                <div className='lg:shadow-2xl lg:m-64 m-8 lg:mr-50 p-3 shadow-2xl shadow-outer  lg:pl-96 lg:pr-96  mt-60 bg-white-500'>
                 <div className='font-semibold mr-15 text-2xl ml-20 flex-col md:mr-36 '>Send Money</div>
                ...
                aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                  <img class="w-9 h-9  rounded-full mt-1  mb-1 ml-4" 
                  src="https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg" alt="user photo"/>
                ...
                <button className='bg-green-600 hover:bg-green-900 border border-white  rounded-lg
                 text-white font-normal text-xs lg:w-60 w-60 h-8 ml-8 -mt-2'>Initiate Transfer</button>
